...
public class GordoObjectEncoder extends MessageToMessageEncoder<Object> {
  private static final Logger log = LoggerFactory.getLogger(GordoObjectEncoder.class);


  public GordoObjectEncoder() {
  }
